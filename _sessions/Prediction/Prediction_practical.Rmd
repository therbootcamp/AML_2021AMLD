...
7. Fit the model on the training data by passing the `lm_workflow` and the `airbnb_train` data to the `fit()` function and save the output as `price_lm`.
...
16. Fit the model on the training data by passing the `dt_workflow` and the `airbnb_train` data to the `fit()` function and save the output as `price_dt`.
...
25. Fit the model on the training data by passing the `rf_workflow` and the `airbnb_train` data to the `fit()` function and save the output as `price_rf`.
...
14. Fit the model on the training data by passing the `dt_workflow` and the `airbnb_train` data to the `fit()` function and save the output as `superhost_dt`.
...
21. Fit the model on the training data by passing the `rf_workflow` and the `airbnb_train` data to the `fit()` function and save the output as `superhost_rf`.
