...
# Parameter tuning with v-fold cross-validation with <mono>tidymodels</mono>
...
# <i>v</i>-fold cross validation for Ridge and Lasso
...
baselers_folds <- vfold_cv(baselers,
                           v = 10)

# Predict income using a workflow
wf_res <- fit_resamples(workflow,
                        baselers_folds)
...
Two ways to specify a grid of parameter values to try:
<ul>
  <li class="m1"><span>Use <mono>grid_regular()</mono> and respective parameter functions.</span></li>
  <li class="m2"><span>Specify a <mono>tibble</mono> and enter specify values yourself.</span></li>
</ul>
...
parameters_grid <- grid_regular(mixture(),
                                penalty(),
                                levels = 50)
...
<mono>tune_grid()</mono> needs
<ul>
  <li class="m1"><span>A <mono>workflow</mono>.</span></li>
  <li class="m2"><span>A resampling scheme.</span></li>
  <li class="m3"><span>A parameter grid.</span></li>
</ul>
...
<ul>
  <li class="m1"><span><mono>tune_grid()</mono> returns fit values of the models with the different hyper-parameter values.</span></li>
  <li class="m2"><span><mono>select_best()</mono> selects the best hyper-parameter values.</span></li>
  <li class="m3"><span>These values can then be added to the workflow using <mono>finalize_workflow</mono>.</span></li>
  <li class="m4"><span>With this final workflow, the model can be fitted using <mono>fit()</mono> and evaluated.</span></li>
</ul>
...
# Recap - Steps of model tuning


.pull-left4[

<ul>
 <li class="m1"><span><high>Split data.</high></span></li>
  <li class="m2"><span>Set up resampling scheme.</span></li>
  <li class="m3"><span>Set up workflow, using <mono>tune()</mono> in the model specification.</span></li>
  <li class="m4"><span>Set up grid of hyper parameters.</span></li>
  <li class="m5"><span>Tune the model with <mono>tune_grid()</mono>.</span></li>
  <li class="m6"><span>Select best hyper-parameter values.</span></li>
  <li class="m7"><span>Finalize workflow with best hyper-parameter values.</span></li>
  <li class="m8"><span>Fit and evaluate final workflow as usual.</span></li>
</ul>
...
<ul>
 <li class="m1"><span>Split data.</span></li>
  <li class="m2"><span><high>Set up resampling scheme.</high></span></li>
  <li class="m3"><span>Set up workflow, using <mono>tune()</mono> in the model specification.</span></li>
  <li class="m4"><span>Set up grid of hyper parameters.</span></li>
  <li class="m5"><span>Tune the model with <mono>tune_grid()</mono>.</span></li>
  <li class="m6"><span>Select best hyper-parameter values.</span></li>
...
<ul>
 <li class="m1"><span>Split data.</span></li>
  <li class="m2"><span>Set up resampling scheme.</span></li>
  <li class="m3"><span><high>Set up workflow, using <mono>tune()</mono> in the model specification.</high></span></li>
  <li class="m4"><span>Set up grid of hyper parameters.</span></li>
  <li class="m5"><span>Tune the model with <mono>tune_grid()</mono>.</span></li>
  <li class="m6"><span>Select best hyper-parameter values.</span></li>
  <li class="m7"><span>Finalize workflow with best hyper-parameter values.</span></li>
...
<ul>
 <li class="m1"><span>Split data.</span></li>
  <li class="m2"><span>Set up resampling scheme.</span></li>
  <li class="m3"><span>Set up workflow, using <mono>tune()</mono> in the model specification.</span></li>
  <li class="m4"><span><high>Set up grid of hyper parameters.</high></span></li>
  <li class="m5"><span>Tune the model with <mono>tune_grid()</mono>.</span></li>
  <li class="m6"><span>Select best hyper-parameter values.</span></li>
  <li class="m7"><span>Finalize workflow with best hyper-parameter values.</span></li>
  <li class="m8"><span>Fit and evaluate final workflow as usual.</span></li>
...
<ul>
 <li class="m1"><span>Split data.</span></li>
  ...
  <li class="m3"><span>Set up workflow, using <mono>tune()</mono> in the model specification.</span></li>
  <li class="m4"><span>Set up grid of hyper parameters.</span></li>
  <li class="m5"><span><high>Tune the model with <mono>tune_grid()</mono>.</high></span></li>
  <li class="m6"><span>Select best hyper-parameter values.</span></li>
  <li class="m7"><span>Finalize workflow with best hyper-parameter values.</span></li>
  <li class="m8"><span>Fit and evaluate final workflow as usual.</span></li>
</ul>
...
lasso_grid <-
  lasso_workflow %>%
  tune_grid(resamples = baselers_folds,
            grid = penalty_grid)
```
...
<ul>
 <li class="m1"><span>Split data.</span></li>
  ...
  <li class="m4"><span>Set up grid of hyper parameters.</span></li>
  <li class="m5"><span>Tune the model with <mono>tune_grid()</mono>.</span></li>
  <li class="m6"><span><high>Select best hyper-parameter values.</high></span></li>
  <li class="m7"><span>Finalize workflow with best hyper-parameter values.</span></li>
  <li class="m8"><span>Fit and evaluate final workflow as usual.</span></li>
</ul>
...
```{r}
best_lasso <- select_best(lasso_grid)
```
...
<ul>
 <li class="m1"><span>Split data.</span></li>
  ...
  <li class="m5"><span>Tune the model with <mono>tune_grid()</mono>.</span></li>
  <li class="m6"><span>Select best hyper-parameter values.</span></li>
  <li class="m7"><span><high>Finalize workflow with best hyper-parameter values.</high></span></li>
  <li class="m8"><span>Fit and evaluate final workflow as usual.</span></li>
</ul>
...
```{r}
final_lasso <- 
  finalize_workflow(lasso_workflow,
                    best_lasso)
```
...
<ul>
 <li class="m1"><span>Split data.</span></li>
  ...
  <li class="m6"><span>Select best hyper-parameter values.</span></li>
  <li class="m7"><span>Finalize workflow with best hyper-parameter values.</span></li>
  <li class="m8"><span><high>Fit and evaluate final workflow as usual.</high></span></li>
</ul>
...
metrics(lasso_pred, truth = income,
        estimate = .pred)
```
