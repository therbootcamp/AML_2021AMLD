...
<ul>
  ...
  <li class="m3"><span>But is there nothing we can do?.</span></li>
</ul>
...
<ul>
  ...
  <br><br>
  <ul class="level">
    <li><span>1 - Create separate validation set.</span></li>
...
<ul>
  ...
  <li class="m6"><span>Retrain and evaluate</span></li><br>
</ul>
...
<ul>
  ...
  <br><br>
  <ul class="level">
    <li><span><font style="font-size:22px"><mono>&alpha;	&isin; {0, .5, 1}</mono></font></span></li>
    <li><span><font style="font-size:22px"><font style="font-size:22px"><mono>&lambda;	&isin; {1, 2, ..., 100}</mono></font></span></li>
  </ul>
  </span></li>
</ul>
